...
public class ItemControllerTest {
	...
	public void testCreate() {
		final String itemName = "ps5";
		final double value = 500.25d;
		final Item created = new Item(itemName, value);
	...
	public void testReadAll() {
		...
		items.add(new Item(1L,"ps5",500.25d));
	...
	Item updated = new Item(1L, "ps5", 400.53d);
