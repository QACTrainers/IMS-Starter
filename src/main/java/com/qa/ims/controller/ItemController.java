...
// Here we put 'Item' details for CRUD functionality - like other Controller classes.	
...
public class ItemController implements CrudController<Item> {
	...
	public Item create() {
		...
		Double item_price = utils.getDouble(); // int or double? can't remember which datatypes Java doesnt like
